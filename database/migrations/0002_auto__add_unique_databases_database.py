...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Databases', fields ['database']
        db.create_unique('database_databases', ['database'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Databases', fields ['database']
        db.delete_unique('database_databases', ['database'])
    ...
    models = {
        ...
        'database.databases': {
            ...
            'database': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
