...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Databases', fields ['username']
        db.create_unique('database_databases', ['username'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Databases', fields ['username']
        db.delete_unique('database_databases', ['username'])
