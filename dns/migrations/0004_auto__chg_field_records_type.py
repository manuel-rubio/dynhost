...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Records.type'
        db.alter_column('dns_records', 'type', self.gf('django.db.models.fields.CharField')(max_length=6))


    def backwards(self, orm):
        
        # Changing field 'Records.type'
        db.alter_column('dns_records', 'type', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'billing.domains': {
            ...
            'email_type': ('django.db.models.fields.CharField', [], {'default': "'V'", 'max_length': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
