...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RedirectDynHost.uri'
        db.add_column('web_redirectdynhost', 'uri', self.gf('django.db.models.fields.TextField')(default='/'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RedirectDynHost.uri'
        db.delete_column('web_redirectdynhost', 'uri')
