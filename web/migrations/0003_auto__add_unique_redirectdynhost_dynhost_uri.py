...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('web_redirectdynhost', ['dynhost_id', 'uri'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RedirectDynHost', fields ['dynhost', 'uri']
        db.delete_unique('web_redirectdynhost', ['dynhost_id', 'uri'])
    ...
    models = {
        ...
        'web.redirectdynhost': {
            'Meta': {'unique_together': "(('uri', 'dynhost'),)", 'object_name': 'RedirectDynHost'},
