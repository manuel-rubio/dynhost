...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Redirect', fields ['username']
        db.delete_unique('mail_redirect', ['username'])

        # Changing field 'Redirect.username'
        db.alter_column('mail_redirect', 'username', self.gf('django.db.models.fields.TextField')(max_length=50))

        # Adding unique constraint on 'Redirect', fields ['username', 'domain']
        db.create_unique('mail_redirect', ['username', 'domain_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Redirect', fields ['username', 'domain']
        db.delete_unique('mail_redirect', ['username', 'domain_id'])

        # Changing field 'Redirect.username'
        db.alter_column('mail_redirect', 'username', self.gf('django.db.models.fields.TextField')(unique=True, max_length=250))

        # Adding unique constraint on 'Redirect', fields ['username']
        db.create_unique('mail_redirect', ['username'])
