...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contracts.ends'
        db.alter_column(u'billing_contracts', 'ends', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Contracts.ends'
        db.alter_column(u'billing_contracts', 'ends', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 22, 0, 0)))
