...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domains.expires'
        db.add_column(u'billing_domains', 'expires',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domains.expires'
        db.delete_column(u'billing_domains', 'expires')
    ...
    models = {
        ...
        u'billing.accounts': {
            ...
            'nic': ('django.db.models.fields.TextField', [], {'null': 'True'}),
