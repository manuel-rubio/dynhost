...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Accounts.limit_sql_users'
        db.add_column('billing_accounts', 'limit_sql_users', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Accounts.limit_sql_users'
        db.delete_column('billing_accounts', 'limit_sql_users')
