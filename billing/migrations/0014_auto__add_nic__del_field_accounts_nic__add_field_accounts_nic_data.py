...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'billing_nic', (
            ...
            ('fax', self.gf('django.db.models.fields.TextField')(null=True)),
            ('addrees', self.gf('django.db.models.fields.TextField')()),
            ...
            ('nic', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'billing', ['NIC'])

        # Deleting field 'Accounts.nic'
        db.delete_column(u'billing_accounts', 'nic')

        # Adding field 'Accounts.nic_data'
        db.add_column(u'billing_accounts', 'nic_data',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.NIC'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Accounts.nic'
        db.add_column(u'billing_accounts', 'nic',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Deleting field 'Accounts.nic_data'
        db.delete_column(u'billing_accounts', 'nic_data_id')
    ...
    models = {
        ...
        u'billing.nic': {
            ...
            'addrees': ('django.db.models.fields.TextField', [], {}),
