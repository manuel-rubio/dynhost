...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Domains.email_type'
        db.alter_column('billing_domains', 'email_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))


    def backwards(self, orm):
        
        # Changing field 'Domains.email_type'
        db.alter_column('billing_domains', 'email_type', self.gf('django.db.models.fields.CharField')(max_length=1))
