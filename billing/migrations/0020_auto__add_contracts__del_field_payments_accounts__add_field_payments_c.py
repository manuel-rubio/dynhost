...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'billing_contracts', (
            ...
            ('frequency', self.gf('django.db.models.fields.CharField')(default='M', max_length=1)),
            ...
            ('ends', self.gf('django.db.models.fields.DateField')(default=None)),
        ))
        db.send_create_signal(u'billing', ['Contracts'])

        # Deleting field 'Payments.accounts'
        db.delete_column(u'billing_payments', 'accounts_id')

        # Adding field 'Payments.contract'
        db.add_column(u'billing_payments', 'contract',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['billing.Contracts']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Payments.accounts'
        db.add_column(u'billing_payments', 'accounts',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['billing.Accounts']),
                      keep_default=False)

        # Deleting field 'Payments.contract'
        db.delete_column(u'billing_payments', 'contract_id')

        # Deleting field 'Accounts.amount'
        db.delete_column(u'billing_accounts', 'amount')
    ...
    models = {
        ...
        u'billing.contracts': {
            ...
            'ends': ('django.db.models.fields.DateField', [], {'default': 'None'}),
            'frequency': ('django.db.models.fields.CharField', [], {'default': "'M'", 'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'billing.nic': {
            ...
            'password': ('django.db.models.fields.TextField', [], {'default': "'dynhost-nic-user'"}),
