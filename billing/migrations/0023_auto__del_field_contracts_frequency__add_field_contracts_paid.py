...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contracts.frequency'
        db.delete_column(u'billing_contracts', 'frequency')

        # Adding field 'Contracts.paid'
        db.add_column(u'billing_contracts', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contracts.frequency'
        db.add_column(u'billing_contracts', 'frequency',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1),
                      keep_default=False)

        # Deleting field 'Contracts.paid'
        db.delete_column(u'billing_contracts', 'paid')
