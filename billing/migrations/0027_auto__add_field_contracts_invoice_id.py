...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contracts.invoice_id'
        db.add_column(u'billing_contracts', 'invoice_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contracts.invoice_id'
        db.delete_column(u'billing_contracts', 'invoice_id')
