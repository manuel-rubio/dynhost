...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NIC.addrees'
        db.delete_column(u'billing_nic', 'addrees')

        # Adding field 'NIC.address'
        db.add_column(u'billing_nic', 'address',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NIC.addrees'
        db.add_column(u'billing_nic', 'addrees',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Deleting field 'NIC.address'
        db.delete_column(u'billing_nic', 'address')
    ...
    models = {
        ...
        u'billing.nic': {
            ...
            'fax': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
