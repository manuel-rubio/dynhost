...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Domains', fields ['domain']
        db.create_unique('billing_domains', ['domain'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Domains', fields ['domain']
        db.delete_unique('billing_domains', ['domain'])
