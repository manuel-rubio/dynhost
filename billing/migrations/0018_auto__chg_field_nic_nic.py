...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NIC.nic'
        db.alter_column(u'billing_nic', 'nic', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'NIC.nic'
        db.alter_column(u'billing_nic', 'nic', self.gf('django.db.models.fields.CharField')(max_length=10))
