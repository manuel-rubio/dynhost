...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domains.contract'
        db.add_column(u'billing_domains', 'contract',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Contracts'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domains.contract'
        db.delete_column(u'billing_domains', 'contract_id')
